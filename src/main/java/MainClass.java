...
//            try {
//                proteinGraph.exportGraph(ProteinGraph.EXPORT_TYPE_CSV, "exports/non-enzyme/" + id,"0");
...
////        proteinGraph.exportGraph(ProteinGraph.EXPORT_TYPE_DOT, directory + id);
//            try {
//                proteinGraph.exportGraph(ProteinGraph.EXPORT_TYPE_CSV, "exports/enzyme/" + id,"1");
//            } catch (FileNotFoundException e) {
//                e.printStackTrace();
//            }
////        proteinGraph.exportGraph(ProteinGraph.EXPORT_TYPE_MATRIX, directory + pdbID[0]);
...
//        MPNNImp.classify(dirs,filenames);
    }
