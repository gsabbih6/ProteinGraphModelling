...
public class MainClass {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ProteinsDataset dataset = new ProteinsDataset();
//        Arrays.asList(pdbID).parallelStream().forEach((id) -> {
...
//            System.out.println();
//            dataset.setDataset(proteinGraph.getProteinAsAX("enzyme"));
//        });
//        System.out.println(dataset);
//        Utils.saveToFile(dataset);
        String[] enzyme = {
                "11AS", "1A26",
...
//            proteinGraph.addAAwithPeptideBonds(aminoAcids);////
//            proteinGraph.addHydrogenBonds(aminoAcidsHBonds);//
//            dataset.setDataset(proteinGraph.getProteinAsAX("nonenzyme"));
//        });
//
...
//                "exports/non-enzyme/"
        ...
        String[][] filenames = {enzyme, nonenzyme};
        new SameDiffGCN().creatModel(0, 0);
    }

    public void evaluate() throws IOException {
        File saveFileForInference = new File("GCNModel83model1.sabbih");
