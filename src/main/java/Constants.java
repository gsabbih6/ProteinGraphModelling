...
public class Constants {
    ...
    public final static int asparagine_aspartic_number = 21;
    public final static String glutamine_glutamic = "Z";
    public final static String glutamine_glutamic_color = "#bccc15";
    public final static int glutamine_glutamic_number = 22;
    ...
    public static int getAANumber(AminoAcid v) {

        Hashtable<String, Integer> numbermap = new Hashtable<>();
